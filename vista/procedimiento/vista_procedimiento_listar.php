        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                 <div class="col-lg-12">
                      ...
                      <input type="text" class="form-control" id="txt_procedimiento"placeholder="Ingrese procedimiento médico"><br>
                 </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                 <div class="col-lg-12">
                      ...
                      <label for="">Nombre</label>
                      <input type="text" id="txt_procedimiento_actual_editar"placeholder="Ingrese procedimiento médico" hidden><br>
                      <input type="text" class="form-control" id="txt_procedimiento_nuevo_editar"placeholder="Ingrese procedimiento médico"><br>
                 </div>
          ...
          <div class="modal-footer">
                <button class="btn btn-primary" onclick="Modificar_Procedimiento()"><i class="fa fa-check"><b>&nbsp;Registrar</b></i></button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"><b>&nbsp;Cerrar</b></i></button>
          </div>
        </div>
    </div>
