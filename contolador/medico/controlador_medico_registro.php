<?php 
	...
	$ncol = htmlspecialchars($_POST['ncol'],ENT_QUOTES,'UTF-8');
	...
	$consulta = $ME->Registrar_Medico($nombres,$apepat,$apemat,$direccion,$movil,$sexo,$fenac,$ndoc,$ncol,$especialidad,$usuario,$contra,$rol,$email);
	echo $consulta;
 ?>
